...
const NewCar = () => {
    ...
    console.log(phoneNumber.length < 10 || mileage === undefined || (carNumber.length !== 8 && carNumber.length !== 9) || (!isClientExist && (fio.split(' ').length !== 3 || fio.split(' ')[0] === undefined || fio.split(' ')[2] === null || fio.split(' ')[2].length === 0)))
